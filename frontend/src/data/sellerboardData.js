...
export const sellerboardPages = {
  ...
  "/ebay": {
    ...
    kpis: [
      ...
      { label: "PRODUCTS", value: "5", delta: "+1", tone: "emerald" },
  ...
  "/ebay/products": {
    ...
    products: [
      ...
      { name: "Smart Home Hub", sku: "SKU-3488", status: "Out of Stock", stats: [{ label: "Revenue", value: "$0" }, { label: "Net Profit", value: "$0" }, { label: "Units Sold", value: "0" }, { label: "Watchers", value: "19" }] },
    ],
  },
  ...
  "/walmart/products": {
    ...
    products: [
      ...
      { name: "ZenBook Air 13", sku: "SKU-7721", status: "Optimal", stats: [{ label: "Revenue", value: "$5,196" }, { label: "Net Profit", value: "$960" }, { label: "Units Sold", value: "4" }, { label: "Buy Box %", value: "85%" }] },
      { name: "Smart Home Hub", sku: "SKU-3488", status: "Out of Stock", stats: [{ label: "Revenue", value: "$0" }, { label: "Net Profit", value: "-$180" }, { label: "Units Sold", value: "0" }, { label: "Buy Box %", value: "0%" }] },
    ],
  },
  ...
  "/amazon/products": {
    ...
    products: [
      ...
      { name: "LED Monitor 27 Pro", sku: "SKU-6034", status: "Overstock", stats: [{ label: "Revenue", value: "$23,348" }, { label: "Net Profit", value: "$4,290" }, { label: "Units Sold", value: "52" }, { label: "Buy Box %", value: "90%" }] },
      { name: "Smart Home Hub", sku: "SKU-3488", status: "Out of Stock", stats: [{ label: "Revenue", value: "$0" }, { label: "Net Profit", value: "-$1,200" }, { label: "Units Sold", value: "0" }, { label: "Buy Box %", value: "0%" }] },
    ],
  },
  ...
  "/shopify/products": {
    ...
    products: [
      ...
      { name: "LED Monitor 27 Pro", sku: "SKU-6034", status: "Overstock", stats: [{ label: "Revenue", value: "$2,694" }, { label: "Net Profit", value: "$520" }, { label: "Units Sold", value: "6" }, { label: "Conversion Rate", value: "1.9%" }] },
      { name: "Smart Home Hub", sku: "SKU-3488", status: "Out of Stock", stats: [{ label: "Revenue", value: "$0" }, { label: "Net Profit", value: "-$140" }, { label: "Units Sold", value: "0" }, { label: "Conversion Rate", value: "0%" }] },
    ],
  },
