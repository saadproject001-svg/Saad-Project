...
const barShades = ["bg-accent/25", "bg-accent/40", "bg-accent/40", "bg-accent/55", "bg-accent", "bg-accent/55", "bg-accent"];
      ...
      <div className="p-4 sm:p-6 lg:p-8">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-6">
          <div className="neu-card rounded-2xl p-6 lg:col-span-4 h-[397px]">
            <div className="font-semibold text-sm text-neu-text">Stock Quantity Trends</div>
            <div className="text-xs text-neu-muted mt-1">By Year, Quarter, Month (2023-2025)</div>
          ...
          <div className="neu-card rounded-2xl p-6 lg:col-span-4 h-[397px]">
            <div className="font-semibold text-sm text-neu-text">Quantity by Region &amp; Warehouse</div>
            <div className="flex justify-center mt-12 relative">
              ...
              <div className="absolute top-16 text-center">
                <div className="text-2xl font-bold text-neu-text">124k</div>
                <div className="text-[10px] text-neu-muted">UNITS</div>
              </div>
            </div>
            <div className="flex gap-8 text-xs text-neu-muted mt-7">
              <span><i className="inline-block w-2 h-2 rounded-full bg-accent mr-2" />North America<br /><span className="ml-4">(45%)</span></span>
              <span><i className="inline-block w-2 h-2 rounded-full bg-accent/40 mr-2" />Europe (30%)</span>
            </div>
          </div>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          <div className="neu-card rounded-2xl lg:col-span-8 overflow-hidden">
            <div className="p-6 flex justify-between">
              <div className="font-semibold text-sm text-neu-text">Product Details by KPI Measure</div>
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="neu-card rounded-2xl p-6">
              <div className="font-semibold text-sm mb-5 text-neu-text">Stock Movement Type</div>
              <div className="flex items-center gap-5">
                <div className="relative">
                  ...
                  <span className="absolute inset-0 flex items-center justify-center text-xs font-bold text-neu-text">100%</span>
                </div>
                <div className="space-y-2 text-[11px] w-full text-neu-text">
